...
# A solution to fix symlinks when untar is made to a non-standard directory - not recommended
# still need to check remainign symlinks anyway, might have an issue with "include"
# replace "13.1" by your version
